...
#define SHOW_IR_VOLTAGE 0
...
#else
  ui_->ir1ValueLabel->setText(QString::number(sendData.adc[anIR_1]));
  ui_->ir2ValueLabel->setText(QString::number(sendData.adc[anIR_2]));
  ui_->ir3ValueLabel->setText(QString::number(sendData.adc[anIR_3]));
#endif
  ...
  ui_->leftFeedbackValueLabel->setText(QString::number(sendData.adc[anFB_A]));
  ui_->rightFeedbackValueLabel->setText(QString::number(sendData.adc[anFB_B]));
